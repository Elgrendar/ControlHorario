 ...
 * dependiendo de que el usuario esté con sesion iniciada o no
 */
function getEstilos()
{
 ...
 * @param $programa es el nombre comercial del aplicativo.
 */
...
function getContent($pagina)
{
    if ($pagina == 'principal') {
        ...
        echo '<h2 class="section__title">' . $pagina . '</h2><h3 id="clock" class="clockIn">00:00:00</h3>';
    }
 ...
 * @param int $version es el número de versión que corre el actual aplicativo.
 */
...
/**
 * Esta función devuelve todos los registros de la BBDD si eres Administrador o RRHH ordenados por idUsuario
 */
 ...
 * Verifica que no tenga un peso superior a 1MB y que sea del tipo jpg,png,gif,jpeg,pdf y le pone un nombre aleatorio
...
/**
 * Esta función envia mensajes de aprobación o denegación de solicitud a todos los RRHH dados de alta en BBDD
 * @param int $idSolicitud es la id de la solicitud a gestionar
 * @param int $idResponsable Que realiza la gestión
 * @param string $estado si es para aprobar la solicitud tendrá el valor aprobado y cualquier otro valor enviara rechazado
 */
...
/**
 * Esta consulta en la BBDD todos los usuarios con el rol de RRHH
 * @return data con los resultados de la consulta
 */
function idRRHH()
{
    global $conexion, $userBBDD, $passBBDD;
...
/**
 * Esta funcion devuelve el codigo html de los usuarios que están dados de alta en el sistema y que no estan
 * dados de baja para incluirlos en un select para enviarles mensajes
 * @return string
 */
...
/**
 * Esta función devuelve el nombre y apellidos del usuario pasado como parametro
 * @param int id del usuario a obtener el nombre
 * @return string Con el nombre del usuario solicitado
 */
...
/**
 * Esta funcion devuelve el codigo html de las solicitudes que están dadas de alta en el sistema y que pertenecen
 * al usuario con sesion iniciada y son del tipo Otros
 * @return string
 */
...
/**
 * Esta funcion devuelve el codigo html de las ausencias que están dadas de alta en el sistema y que pertenecen
 * al usuario con sesion iniciada
 * @return string
 */
...
/**
 * Esta funcion calcula la diferencia entre la fecha actual y la fecha de alta del usuario
 * y la convierte a años meses y dias
 * @param date Fecha de alta del usuario
 * @return string Con la antiguedad del usuario
 */
